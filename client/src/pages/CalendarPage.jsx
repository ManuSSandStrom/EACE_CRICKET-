...
const governmentHolidays = [
  ...
  { date: '2026-03-21', name: 'Id-ul-Fitr (Ramzan)' },
  { date: '2026-03-31', name: 'Mahaveera Jayanti' },
  { date: '2026-04-03', name: 'Good Friday' },
  { date: '2026-04-14', name: 'Dr. B.R. Ambedkar Jayanthi' },
  { date: '2026-04-20', name: 'Basava Jayanthi' },
  ...
  { date: '2026-10-20', name: 'Mahanavami / Ayudha Pooja' },
  { date: '2026-10-21', name: 'Vijayadashami' },
  { date: '2026-10-25', name: 'Maharshi Valmiki Jayanthi' },
  { date: '2026-11-01', name: 'Kannada Rajyotsava' },
  { date: '2026-11-08', name: 'Naraka Chaturdashi' },
